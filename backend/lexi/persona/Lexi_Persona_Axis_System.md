...
* For architecture or roadmap questions: see `/lexi/persona/Lexi_Persona_Axis_System.md`
* For LLM prompt tuning: see `/lexi/utils/emotion_axis.py`
* For persona mode definitions: `/lexi/persona/persona_modes.json`
