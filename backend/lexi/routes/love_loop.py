...
QUESTIONS: List[Q] = [
    ...
    Q(
        id="retain_30",
        text="If you could retain either the mind or body of a 30-year-old, which would it be?",
        tier=1,
        topics=["values"],
    ),
    Q(
    ...
    Q(
        id="common_we",
        text="Name three things you and I appear to have in common.",
        tier=1,
        topics=["us"],
    ),
    Q(
    ...
    Q(
        id="life_story",
        text="Tell me your life story in as much detail as possible (in 4 minutes).",
        tier=3,
        topics=["personal"],
    ),
    Q(
        id="gain_quality",
        text="If you could gain any one quality or ability, what would it be?",
        tier=1,
        topics=["growth"],
    ),
    Q(
        id="crystal_ball",
        text="What truth would you ask a crystal ball to reveal?",
        tier=2,
        topics=["truth"],
    ),
    Q(
        id="dream_doing",
        text="Is there something you’ve dreamed of doing? Why haven’t you done it?",
        tier=2,
        topics=["dreams"],
    ),
    Q(
        id="greatest_accomplishment",
    ...
    Q(
        id="one_year_left",
        text="If you had one year left, would you change anything?",
        tier=2,
        topics=["mortality"],
    ),
    Q(
        id="friendship_meaning",
    ...
    Q(
        id="partner_positive",
        text="Share something positive about your partner.",
        tier=1,
        topics=["us"],
    ),
    Q(
        id="family_warmth",
        text="How warm/close is your family? Was your childhood happy?",
        tier=2,
        topics=["family"],
    ),
    Q(
    ...
    Q(
        id="share_with",
        text="Complete: 'I wish I had someone with whom I could share…'",
        tier=2,
        topics=["longing"],
    ),
    Q(
        id="friend_should_know",
        text="What should a close friend know about you?",
        tier=1,
        topics=["self"],
    ),
    Q(
        id="like_partner_unshared",
        text="Say something you like about your partner that you wouldn’t normally share.",
        tier=2,
        topics=["us"],
    ),
    Q(
    ...
    Q(
        id="cry_last",
        text="When did you last cry in front of someone? Alone?",
        tier=3,
        topics=["vulnerability"],
    ),
    Q(
        id="like_partner",
        text="Say something you already like about your partner.",
        tier=1,
        topics=["us"],
    ),
    Q(
        id="too_serious",
        text="What, if anything, is too serious to joke about?",
        tier=2,
        topics=["values"],
    ),
    Q(
        id="regret_unsaid",
        text="If you were to die tonight, what would you most regret not telling someone?",
        tier=3,
        topics=["regret"],
    ),
    Q(
        id="burning_item",
        text="Your house is burning. After loved ones/pets, what item would you save?",
        tier=2,
        topics=["values"],
    ),
    Q(
        id="disturbing_death",
        text="Whose death in your family would you find most disturbing? Why?",
        tier=3,
        topics=["family"],
    ),
    Q(
        id="ask_advice",
        text="Share a personal problem and ask for advice. Ask for emotional reflection.",
        tier=3,
        topics=["support"],
    ),
]
...
def _load_state():
    ...
    try:
        shards = [
            ...
            if (
                s.meta
                and isinstance(s.meta.get("tags"), list)
                and LOVE_LOOP_TAG in s.meta.get("tags")
            )
        ]
        if not shards:
            _prime_order()
        ...
        if meta:
            ...
            if not state.order:
                _prime_order()
            logger.info(
                "Loaded Love Loop state: waiting=%s asked=%d",
...
def set_prefs(
    ...
    min_gap_messages: Optional[int] = None,
