...
def nudge_vector_toward(
    vector: Dict[str, float], target: float = 1.0, rate: float = 0.03
) -> Dict[str, float]:
...
if __name__ == "__main__":
    print("AXES:", AXES)
    print(
        "Type a message (with !, caps, cursing, etc) to see surface cues extracted. LLM scoring requires a function."
    )
    while True:
