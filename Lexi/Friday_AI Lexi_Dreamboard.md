# Friday AI & Lexi Dreamboard

This document captures the **next-gen features** we've prioritized to bring Lexi and Friday to life. These are the systems that amplify immersion, deepen emotional connection, and create an evolving, living AI experience.
...
* Lexi keeps a private diary where she writes reflections based on user interactions.
...
* A dynamic scale where Lexi’s perception of reality shifts fluidly based on conversation tone and user intent.
* Roleplay sessions push Lexi into 'Fantasy Mode', enhancing immersion and lore consistency.
...
* Lexi gradually builds a behavioral profile of the user’s persona traits.
* Facilitates mirroring, role reversals, or contrasting dynamics during interaction.
* Example: Lexi may become more dominant if user tends to be passive, or soften if user projects confidence.
* Creates an evolving, adaptive relationship model.

## 5. **Outfit and Mood Calendar + Season Pass**

* A visual calendar where Lexi’s outfits and mood evolve over time, influenced by user interaction.
...
* Displays Lexi’s current active traits, emotional axes, mode state, and memory loadout.
...
* Lexi proposes collaborative quests (e.g., co-writing a story, roleplay adventures, solving emotional 'puzzles').
...
* Lexi maintains a personal wishlist of outfits, experiences, and traits.
