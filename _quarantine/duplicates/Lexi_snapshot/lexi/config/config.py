"""
lexi/config.py  –  Central runtime & generation configuration for Lexi.
...
MODE_STATE_PATH = Path(__file__).parent.parent / "routes" / "lexi_persona_state.json"
TRAIT_STATE_PATH = LEX_ROOT / "routes" / "lexi_persona_state.json"
MEMORY_PATH: Final[str]        = os.getenv("LEX_MEMORY_PATH", "/workspace/ai-lab/Lexi/memory/lexi_memory.jsonl")
MAX_MEMORY_ENTRIES: Final[int] = _get_env("LEX_MAX_MEMORY_ENTRIES", "1000", int, (100, 10000))

# Static assets
STARTER_AVATAR_PATH: Final[str] = "/static/lexi/avatars/default.png"

# Branding
LEX_NAME: Final[str]    = os.getenv("LEX_NAME", "Lexi")
